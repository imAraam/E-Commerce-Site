<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="E_commerce_website.Report" 
...
<div class = "report">
	...
	<h2 style = "font-size: 23px;"><b> Overview of design process </b></h2>
	
	<!-- Justification for design decisions -->
	<!-- Exploration of the design of the pages using wireframe as evidence of process -->
	<!-- Utlisations of academic resources -->
	<!-- responsive design -->
	
	<p>In this report I will go through website description, target audience, functionality and implenetation, elements of interactivity, page run-down 
	as well as justification for final layout and use of colour.</p>
